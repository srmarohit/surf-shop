...
module.exports = {
   ...
   // Landing page to show Clustr Map
   ...
   // GetRegister
      getRegister(req,res,next){
           res.render('registeration',{title:'registerationForm'});
      },
  ...
  async	postRegister(req,res,next){
    ...
    async postLogin(req,res,next){
         ...
         const {username, email} = req.body ;
          const {user} = res.locals ;
           ...
           if(req.file) {
              ...
              // bind with login using util module require higher node version > 8.4.2
     ...
     async putForgotPw(req,res,next){
        ...
        const msg ={
          to: email,
          from:'Surf-Shop Admin <srmarohit@gmail.com>',
     ...
     async getResetPw(req,res,next){
      ...
      If you did not make this change, please hit reply and notify us at once.`.replace(/     /g, '')
        ...
        await sgMail.send(msg);
           ...
           req.session.success = 'Password Successfully Reset';
        res.redirect('/');
